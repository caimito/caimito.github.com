...
Eine bisher noch relativ unbekannte Technik dafür ist Activity-Centered Design <!-- Link entfernt: /de/acd.html (eingestellt) -->. Dieser Artikel im Notizblog bietet nicht genügend Raum, um darzustellen wie Activity-Centered Design hilft besser zu verstehen was Anwender mit Software machen wollen. Ich möchte daher auf das kostenlos abrufbare [Beispielkapitel](http://samples.leanpub.com/activitycentereddesign-sample.pdf) meines Buches zum Thema verweisen.
